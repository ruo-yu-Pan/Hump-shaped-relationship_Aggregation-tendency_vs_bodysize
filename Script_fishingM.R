...
setwd(paste0(wd, "/SizeAggregTend_data/raw_data/stock_assessment"))
...
write.csv(fishingM, file = paste0(wd, "SizeAggregTend_data/compiled/fishingM.csv"), row.names = FALSE)